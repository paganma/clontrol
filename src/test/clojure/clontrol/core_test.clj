...
(deftest core-test
  ...
  (testing "Examples"
    ...
    (testing "Stateful Generator with Local Shifters"
    ...
    (testing "Stateful Generator with Global Shifters"
      (defn-shift yield [x] (shift (fn [k] [k x])))
  ...
  (testing "Local Shifter Declaration"
